package com.example.spring_crudrefugiospring;
...
public class SpringCrudRefugioSpringApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringCrudRefugioSpringApplication.class, args);
    }
